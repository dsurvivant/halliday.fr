$(function()
{
	...
	//Bouton supprimer confirmation de suppression
		$('#formutilisateur #btn_supprimer').click(function(e)
		{
			e.preventDefault();
			if(confirm("Confirmer la suppression de ce membre"))
			{
				chemin = $('#formutilisateur').attr("action") + "&supprimer";
				$('#formutilisateur').attr("action", chemin);
