...
<!--					-->
	<div class="row">
		...
		<p class="jumbotron">	
			A quelques jours de Noël ces quatre dates 15,16,20 et 21 décembre concluent la tournée « Plus près de vous » dans une ambiance magique. Johnny offre pour la 1ère fois en concert un bijou de 1977 Le cœur en deux.  Le public ravi retrouve également les standards : Que je t’aime, Gabrielle, Marie, Allumer le feu, Diégo…, Le Pénitencier avant un final en apothéose où Johnny, heureux de retrouver cette salle où il n’est plus venu depuis 1995, enchaîne : L’Envie, Essayez, La Musique que j’aime et un déchirant M’arrêter-là.
	 		...
	 		Réclamé par les fans BERCY 2003 avait fait l’objet d’une pétition pour sa publication. Mais la sortie du concert au Parc des Princes, enregistré en juin 2003, l’avait empêchée. Aujourd’hui cette injustice est réparée et le public va pouvoir retrouver Johnny Hallyday éclatant et revivre enfin ce live inédit.
	 	</p>
	</div>
	...
	<div class="row">
		...
		<div class="bercy2003 col-lg-3 col-md-4 col-sm-6">
			...
			<div>
				<h3>Bercy 2003</h3>
				<h4>SORTIE LE 11 décembre 2020</h4>
				<div>
					<br>
					<strong>Coffret 4 LP Inclus 4 photos 30x30CM - Picture Vinyle</strong><br>

					Édition limitée et numérotée (500 premiers numéros sur le store)<br><br>
		...
		<div class="bercy2003 col-lg-3 col-md-4 col-sm-6">
			...
			<div>
				...
				<div>
					<br>
					<strong>Double vinyle noir standard pochette simple</strong><br><br><br>
				</div>
				<br>
			</div>
		</div>
		...
		<div class="bercy2003 col-lg-3 col-md-4 col-sm-6">
			...
			<div>
				<h3>Bercy 2003</h3>
				<h4>Sortie le 11 decembre 2020.</h4>
				<div>
					<br>
					<strong>EDITION DIGIPACK 2CD</strong><br><br><br>
				</div>
				<br>
			</div>
		</div>
		...
		<div class="bercy2003 col-lg-3 col-md-4 col-sm-6">
			...
			<div>
				...
				<div>
					<br>
					<strong>Vinyle 45T</strong><br>
					limité et numéroté. Les 500 premiers numéros en précommande exclusive sur la boutique<br><br>
				</div>
				<br>
			</div>
		</div>
		...
		<div class="bercy2003 col-lg-3 col-md-4 col-sm-6">
			...
			<div>
				...
				<div>
					<br>
					<strong>COFFRET 4LP - Inclus 4 photos 30x30CM</strong><br>
					Tirage limité et numéroté <br><br>
		...
		<div class="bercy2003 col-lg-3 col-md-4 col-sm-6">
			...
			<div>
				...
				<div>
					<br>
					<strong>PICTURE VINYLE</strong><br>
					ÉDITION LIMITÉE ET NUMÉROTÉE<br><br>
				</div>
				<br>
		...
		<div class="bercy2003 col-lg-3 col-md-4 col-sm-6">
			...
			<div>
				...
				<div>
					<br>
					<strong>DOUBLE VINYLE + PICTURE VINYLE</strong><br>
					Double vinyle noir standard pochette simple<br>
					Picture vinyle en édition limitée et numérotée<br>
				</div>
				<br>
		...
		<div class="bercy2003 col-lg-3 col-md-4 col-sm-6">
			...
			<div>
				<h3>Bercy 2003</h3>
				<h4>Sortie 11 décembre 2020.</h4>
				<div>
					<br>
					<strong>2 CD ÉDITION DIGIPACK + PICTURE VINYLE</strong><br>
					Picture vinyle en édition limitée et numérotée
				</div>
				<br><br><br>
			</div>
		</div>
